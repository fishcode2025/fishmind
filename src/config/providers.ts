...
import AiHubMixProviderLogo from '@assets/images/providers/aihubmix.jpg'
...
import GraphRagProviderLogo from '@assets/images/providers/graph-rag.png'
...
export function getProviderLogo(providerId: string) {
  console.log('getProviderLogo Debug:', {
    providerId,
    availableLogos: {
  ...
  switch (providerId) {
    ...
    default:
      console.warn('Provider logo not found:', providerId);
      return undefined
  }
}
